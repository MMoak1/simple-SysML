...
template <> constexpr inline auto BlockView::qt_create_metaobjectdata<qt_meta_tag_ZN9BlockViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'enterStateMachineRequested'
        QtMocHelpers::SignalData<void(BlockView *)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 8 },
        }}),
        // Slot 'updateColor'
        QtMocHelpers::SlotData<void(const QColor &)>(9, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QColor, 10 },
        }}),
        // Slot 'updateLabel'
...
void BlockView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->enterStateMachineRequested((*reinterpret_cast< std::add_pointer_t<BlockView*>>(_a[1]))); break;
        case 3: _t->updateColor((*reinterpret_cast< std::add_pointer_t<QColor>>(_a[1]))); break;
        case 4: _t->updateLabel((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 5: _t->updatePosition((*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[1]))); break;
        case 6: _t->updateSize((*reinterpret_cast< std::add_pointer_t<QSizeF>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (BlockView::*)(BlockView * , BlockView * )>(_a, &BlockView::connectionCompleted, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (BlockView::*)(BlockView * )>(_a, &BlockView::enterStateMachineRequested, 2))
            return;
    }
}
...
// SIGNAL 2
void BlockView::enterStateMachineRequested(BlockView * _t1)
{
